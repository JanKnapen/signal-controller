# SignalController# SignalController# SignalController# SignalController



FastAPI service for sending and receiving Signal messages via signal-cli.



## FeaturesA FastAPI service for sending and receiving Signal messages via signal-cli REST API.
...
- SQLite database for message history## FeaturesA FastAPI-based service for sending and receiving Signal messages via signal-cli REST API.A secure service for receiving and sending Signal messages via signal-cli REST API, designed to run on a Proxmox VM.
...
Internet → Cloudflare Tunnel → VM:8888 (public) → signal-cli:8080
...
## Installation- ☁️ **Cloudflare Ready** - Works with Cloudflare Tunnel for SSL termination
